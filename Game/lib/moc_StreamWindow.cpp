...
static const char qt_meta_stringdata_StreamWindow[] = {
    "StreamWindow\0"
};
...
const QMetaObjectExtraData StreamWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StreamWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_StreamWindow,
      qt_meta_data_StreamWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StreamWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StreamWindow))
