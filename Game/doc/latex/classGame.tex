...
You can override this function for event handling. However, it doesn\textquotesingle{}t handle mouse events. 
...
\hline
\end{DoxyParams}
\index{Game@{Game}!selected\+Rect@{selected\+Rect}}
...
When S\+E\+N\+D\+\_\+\+C\+O\+M\+M\+A\+N\+D\+S\+\_\+\+L\+A\+TE if off it is run right after \hyperlink{classGame_aab44617eccac431efb47e8737740b9f6}{sync()}. Otherwise it is run after turn\+Duration which is either specified or measured automatically (not recommended)
